...
public class PlayScreen extends ScreenAdapter {
    ...
    public PlayScreen(MiniGameCollection mOriginGame){
        ...
        exePrefs = Gdx.app.getPreferences("exepreference");
...
/*      System.out.println("LogRight" + csu.mLogsRight.size());
    ...
    private void updateGameOver() {
        ...
        //exePrefs.putInteger("EXP", inthigh);
        //exePrefs.flush();
        minioriginGame.setScreen(new GameOverScreen(minioriginGame, Score, inthigh));
    }
