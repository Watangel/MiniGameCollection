...
public class GameScreenWithStage extends ScreenAdapter {
    ...
    public GameScreenWithStage(MiniGameCollection game){
        ...
        homeButton.addListener(new InputListener(){
            ...
            //ステージ
        stopStage = new Stage(new FitViewport(300, 450));
        ...
        stopStage.getViewport().getCamera().rotateAround(new Vector3(0, 0, 0), new Vector3(0, 0, 1), 90);
        stopStage.getViewport().getCamera().position.x += 450;
        ...
        stage = new Stage(new FitViewport(300, 450));
        ...
        stage.getViewport().getCamera().rotateAround(new Vector3(0, 0, 0), new Vector3(0, 0, 1), 90);
        stage.getViewport().getCamera().position.x += 450;
    }
